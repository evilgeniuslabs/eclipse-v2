/*
   Eclipse v2: https://github.com/evilgeniuslabs/eclipse-v2
...
#define HOSTNAME "Eclipse-ESP8266-" ///< Hostname. The setup function adds the Chip ID at the end.
...
const char *ssid = "pup";
const char *password = "9135448977";
...
PatternAndNameList patterns = {
    ...
    //  { analogClockWithMillis,  "Analog Clock with Milliseconds" },
